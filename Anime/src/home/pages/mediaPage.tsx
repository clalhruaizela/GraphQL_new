    ...
    <div className="w-full h-full">
      <div className="flex flex-col">
        ...
        <div className=" bg-gray-100   px-4  mt-10  ">
          {/* <div className=""> */}
          <div className=" mx-auto py-4 mt-4  bg-white text-black text-nowrap flex flex-row justify-center overflow-x-auto ">
            <div className="w-full  text-gray-500 font-medium items-center  flex whitespace-nowrap text-xs ">
              <div className=" pr-10  px-2 ">
          ...
          <div>
            <div>
              ...
              <div>
                {data2?.Media?.recommendations?.edges?.map((recommendation) => (
                  <Card key={recommendation?.id}>
                    {/* <div className="flex">
                      <img
                        src={recommendation?.coverImage?.medium || ""}
                        alt={recommendation?.title?.english || ""}
                        className="w-24 h-28 rounded-l-sm "
                      />
                      <div className="flex flex-col gap-2 text-sm pl-2">
                        <h4 className="text-blue-400 pt-2">Source</h4>
